  ...
  return (
    <>
      ...
      >
        ...
        <div className="card col-12 m-3 shadow p-3" style={{backgroundColor:'#453445'}}>
          <div className="card-body row">
            ...
            <div className="col-4">
              ...
              <h4>Subjects</h4>
              {book.subjects && book.subjects.map((s,i) => {
                return(
                  <h6 style={{color:"#888"}} key={i}>{s}</h6>
                )
              })}
                <h4>authors</h4>
               {book.authors && book.authors.map((a,i) => {
                return(
                  ...
                  <div key={i}>
                  <h6  >Name : <span style={{color:"#777"}}>{a.name}</span></h6>
                  <h6  >Birth year : <span style={{color:"#777"}}>{a.birth_year}</span></h6>
                  <h6  >Death year : <span style={{color:"#777"}}>{a.death_year}</span></h6>
                  </div>
